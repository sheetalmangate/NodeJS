...
const addEmployee = async () => {
    ...
    inquirer
        ...
        db.query('INSERT INTO employee(first_name, last_name, role_id, manager_id) VALUES($1,$2,$3,$4)', [first_name, last_name, role_id, manager_id], (err, result) => {
...
const addRole = async () => {
    ...
    inquirer
        ...
        db.query('INSERT INTO role(title, salary, department_id) VALUES($1,$2,$3) ', [title, salary, department_id], (err, result) => {
            if (err) {
                console.log(err);
                return;
            }
...
const updateEmpoyeeRole = async () => {
    ...
    inquirer
        ...
        db.query(`UPDATE employee SET role_id = ${role_id} WHERE id = ${employee_id}`, [], (err, result) => {
            ...
            if (result.rowCount === 1)
                message = 'Role for employee updated successfully';
            console.log(message);
            init();
        });
    });
